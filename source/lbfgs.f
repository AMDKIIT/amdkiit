...
C
     ...
     *                     GNORM,N,M,X,F,G,STP,FINISH,I_TER)
      ENDIF
C
C    --------------------
...
C
 10   FORMAT('')
 20   FORMAT('  NUMBER OF CORRECTIONS =',I2,
     .       /,  '       INITIAL VALUES')
 30   FORMAT(' ENERGY = ',F16.6,'   GNORM = ',1PD10.3)
 40   FORMAT(' VECTOR X = ')
 50   FORMAT(3(2X,1PD10.3))
